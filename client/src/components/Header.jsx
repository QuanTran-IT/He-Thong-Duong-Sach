export default function Header({ page, navigate, query, setQuery, language, toggleLanguage }) {
    const links = language === 'vi'
        ? [['home', 'Trang chủ'], ['events', 'Sự kiện'], ['map', 'Bản đồ'], ['heritage', 'Di sản'], ['feedback', 'Góp ý'], ['management', 'Ban quản lý']]
        : [['home', 'Home'], ['events', 'Events'], ['map', 'Map'], ['heritage', 'Heritage'], ['feedback', 'Feedback'], ['management', 'Management']];
